...
const CardItem = (props) => {
  ...
  return (
    <div className={"card-item " + style} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
      ...
      <div className="card-include ">
        <div className="card-include-title">{props.title} New Company formation includes</div>
        <CardIncludeList />
      </div>
